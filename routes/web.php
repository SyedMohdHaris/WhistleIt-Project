...
Route::middleware('auth')->prefix('/channel')->group(function () {
    Route::post('', [ChannelsController::class, 'addChannel']);
    Route::post('/addMemeber',[ChannelsController::class,'addChannelMember']);
    Route::post('/removeMember',[ChannelsController::class,'removeChannelMember']);
    Route::post('/getMembers',[ChannelsController::class,'getChannelMembers']);
